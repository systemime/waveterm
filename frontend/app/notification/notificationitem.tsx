...
const NotificationItem = ({
    ...
    const renderCloseButton = () => {
        if (!isBubble && persistent) {
            return (
                <span className="lock-btn" title={t("notification.cannotBeCleared", undefined, "Cannot be cleared")}>
    ...
    return (
        <div
            ...
            onClick={() => onCopy(id)}
            title={t("notification.clickToCopy", undefined, "Click to Copy Notification Message")}
        >
            {renderCloseButton()}
