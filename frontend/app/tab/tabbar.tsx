...
const ConfigErrorMessage = () => {
        ...
        return (
            <div className="max-w-[500px] p-5">
                <h3 className="font-bold text-base mb-2.5">
                    {t("tabBar.configCleanTitle", undefined, "Configuration Clean")}
                </h3>
                <p>
                    {t("tabBar.configCleanBody", undefined, "There are no longer any errors detected in your config.")}
                </p>
            </div>
        );
    }
    if (fullConfig?.configerrors.length == 1) {
        ...
        return (
            <div className="max-w-[500px] p-5">
                <h3 className="font-bold text-base mb-2.5">
                    {t("tabBar.configErrorTitle", undefined, "Configuration Error")}
                </h3>
                <div>
...
const ConfigErrorIcon = ({ buttonRef }: { buttonRef: React.RefObject<HTMLElement> }) => {
    ...
    return (
        ...
        >
            ...
            {t("tabBar.configErrorButton", undefined, "Config Error")}
        </Button>
    );
};
