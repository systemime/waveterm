            ...
            const handleContextMenu = useCallback(
                (e: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
                    ...
                    if (currentIndicator) {
                        menu.push(
                            {
                                label: t("tab.clearIndicator", undefined, "Clear Tab Indicator"),
                                click: () => setTabIndicator(id, null),
                            },
                            {
                                label: t("tab.clearAllIndicators", undefined, "Clear All Indicators"),
                    ...
                    menu.push(
                        { label: t("tab.rename", undefined, "Rename Tab"), click: () => handleRenameTab(null) },
                        {
                            label: t("tab.copyTabId", undefined, "Copy TabId"),
                    ...
                    if (bgPresets.length > 0) {
                        ...
                        menu.push(
                            {
                                label: t("tab.backgrounds", undefined, "Backgrounds"),
                                type: "submenu",
                                submenu,
                            },
                            { type: "separator" }
                    ...
                    menu.push({ label: t("tab.close", undefined, "Close Tab"), click: () => onClose(null) });
                    ...
                    <div className="tab-inner">
                        ...
                        {indicator && (
                            <div
                                ...
                                title={t("tab.activityNotification", undefined, "Activity notification")}
                            >
                        ...
                        <Button
                            ...
                            title={t("tab.close", undefined, "Close Tab")}
                        >
